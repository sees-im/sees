...
import { adminLogin, adminLogout, checkAdminAuth, getAdminStats } from "@/lib/admin.functions";

export const Route = createFileRoute("/admin")({
  component: AdminPage,
  head: () => ({
    meta: [{ title: "Admin — SEES" }, { name: "robots", content: "noindex,nofollow" }],
  }),
});
      ...
      <div className="admin-card">
        ...
        {checking ? (
          ...
          <form onSubmit={submitLogin} className="admin-login">
            ...
            <button
              type="submit"
              disabled={busy || !password || !turnstileToken}
