...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.sees.im/contact" },
    ],
    ...
    <div className="marketing-site contact-page-premium min-h-screen bg-background text-foreground flex flex-col">
      ...
      <main className="contact-page-premium__main flex-1">
        <section className="site-shell contact-page-premium__hero">
          <div className="contact-page-premium__index" aria-hidden>
            03 / CONTACT
          </div>
          <div className="contact-page-premium__copy">
            ...
            <p className="contact-page-premium__lead">
              Questions, ideas, or a problem worth solving? Put it in writing. The team will pick it
              up from here.
            </p>
            <div className="contact-page-premium__meta">
              <span>
                <ShieldCheck className="size-4" strokeWidth={1.6} /> Stored through the protected
                channel
              </span>
            </div>
          </div>
          <div className="contact-page-premium__card">
            <div className="contact-page-premium__cardbar">
              <span>SEES / 03</span>
