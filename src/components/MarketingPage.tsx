...
export function MarketingHeader() {
  ...
  return (
    <header className="marketing-header">
      ...
      <div id="marketing-site-menu" className={`mobile-menu-panel ${menuOpen ? "is-open" : ""}`}>
      ...
      <div className="marketing-shell">
        ...
        <div className="footer-bottom">
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-2">
            ...
            {/* Plain anchor: /404 is the catch-all, not a route, so this has to
                hit the server to render the real not-found response. */}
            <a href="/404">404</a>
          </div>
...
export function Pill({ children }: { children: React.ReactNode }) {
  return <span className="marketing-pill">{children}</span>;
}
